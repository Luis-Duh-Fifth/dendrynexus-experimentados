...
(function() {
  ...
  UserInterface.prototype.displayMyNewRow = function(items) {};
...
for (var c of choices) {
    ...
    if (choiceScene.isDeck) {
        ...
        c.image = choiceScene.cardImage;
        pinnedCards.push(c);
    } else if (choiceScene.isMyNewRowType) {
        c.image = choiceScene.cardImage;
        myNewRowItems.push(c);
    }
}
...
if (myNewRowItems.length > 0) {
    this.ui.displayMyNewRow(myNewRowItems);
}
    } else {
